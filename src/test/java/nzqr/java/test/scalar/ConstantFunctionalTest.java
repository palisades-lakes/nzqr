...
import static nzqr.java.test.scalar.Common.constantKnots;
import static nzqr.java.test.scalar.Common.constantTestPts;
...
import nzqr.java.functions.scalar.ConstantFunctional;

//----------------------------------------------------------------
/** Test constant 'interpolants'. 
 * <p>
 * <pre>
 * mvn -q -Dtest=nzqr/java/test/scalar/ConstantFunctionTest test > ConstantFunctionTest.txt
 * </pre>
 *
