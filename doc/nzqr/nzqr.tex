...
\citeAuthorYearTitle[sections 3.1--3.2]{HansonSussman:2021:SDFF}.
...
An alternate implementation that adds Schönhage–Strassen
to the sequence of tests choosing between
single {\javaFont int}, grade-school, Karatsuba, and
Toom-Cook can be found at 
\cite{tbuktu:2015:EfficientBigIntegerImplementation}.

There are algorithms which are even faster,
for much larger numbers.

\textit{Fürer}'s algorithm~\cite{ wiki:FurerMultiplication}
potentially outperforms Schönhage–Strassen,
