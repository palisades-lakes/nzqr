...
set XMX=-Xms10g -Xmx10g -Xmn4g

::set PROF=
set PROF=-agentpath:"C:\Program Files\YourKit Java Profiler 2023.9-b103\bin\windows-x86-64\yjpagent.dll=_no_java_version_check"
